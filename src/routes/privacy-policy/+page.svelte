...
<div class="page">
	<div class="header">
		<div class="container">
			<p class="title">Privacy Policy for Code Carton</p>
		</div>
	</div>
	<div class="translations-content-container">
		<div class="container">
			<div class="tab-content translations-content-item en visible" id="en">
				...
				<ul>
					...
					<li>
						<p>
							...
							&quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Code Carton, LLC
						</p>
					</li>
					<li>
						<p>
					...
					<li>
						<p>
							<strong>Website</strong> refers to Code Carton, accessible from
							<a href="www.codecarton.com" rel="external nofollow noopener" target="_blank"
								>www.codecarton.com</a
							>
						</p>
					</li>
					<li>
				...
				<ul>
					<li>By email: hello@codecarton.com</li>
				</ul>
			</div>
		</div>
	</div>
